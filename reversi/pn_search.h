...
public:
	pn_search() : move_number_(0) {
        ...
        rocksdb::Status status = rocksdb::DB::OpenForReadOnly(options, "/Users/lemonshark05/Documents/github/gomoku-first-move-always-win/gomoku/script/no_restrituion_reversi.db", &db);
#endif
	}
